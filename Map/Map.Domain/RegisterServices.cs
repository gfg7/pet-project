...
namespace Map.Domain
{
    public static class RegisterServices
    {
        public static IServiceCollection RegisterDomain(this IServiceCollection services)
        {
            ...
            services.RegisterDatabase<NpgsqlConnection, PostgresConnectionProvider, TransactionDbService<NpgsqlConnection>>();
        ...
        public static IServiceCollection RegisterDatabase<C, F, S>(this IServiceCollection services)
